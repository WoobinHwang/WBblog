...
![png](/_posts/0408_IMDB.md/output_17_0.png)
...
![png](/_posts/0408_IMDB.md/output_33_0.png)
...
![png](/_posts/0408_IMDB.md/output_38_0.png)
...
- **TensorFlow 패키지**
  - **pad_sequences()**: 시퀀스 길이를 맞추기 위해 패딩을 추가. (샘플 개수, 타임스텝 개수)크기의 2차원 배열을 기대
